...
async def end_dialog(message: types.CallbackQuery):
    ...
    await bot.send_message(message.from_user.id,
                           'Хорошо, если у тебя больше нет вопросов или нужды в моей помощи, я закончу этот чат. Если в будущем у тебя возникнут вопросы или нужна будет поддержка, не стесняйся обратиться. Удачи в поиске любви и во всех твоих усилиях на пути к ней! Прощай!', reply_markup=initial_data)
