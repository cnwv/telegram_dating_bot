...
async def process_message(message: types.Message):
    ...
    # TODO: добавить проверку на длину сообщения и сделать чтобы сообщение дробилось, если оно больше 4096 символов
    await message.answer(response,
                         reply_markup=register_end_dialog_button(
                             add_payment=True if response == Telegram.expire_text else False))
